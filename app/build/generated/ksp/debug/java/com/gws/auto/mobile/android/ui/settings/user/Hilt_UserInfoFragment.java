...
public abstract class Hilt_UserInfoFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_UserInfoFragment() {
    super();
  }

  Hilt_UserInfoFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((UserInfoFragment_GeneratedInjector) this.generatedComponent()).injectUserInfoFragment(UnsafeCasts.<UserInfoFragment>unsafeCast(this));
    }
  }
