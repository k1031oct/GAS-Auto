...
public abstract class Hilt_ThemeFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ThemeFragment_GeneratedInjector) this.generatedComponent()).injectThemeFragment(UnsafeCasts.<ThemeFragment>unsafeCast(this));
    }
  }
